	...
	<body>
		...
		<?php endif; ?>
			...
			<div class="container-form-register-event">
				<form action="banco-eventos.php" method="post" enctype="multipart/form-data">
					...
					<textarea class="description-event" name="descricao" required></textarea>
					
					<input type="file" multiple  name="arquivo[]" required>
					
					<?php if(isset($_SESSION["evento_cadastrado"])): ?>
						<p class="evento-cadastrado"><?=$_SESSION["evento_cadastrado"]; ?></p>
						<?php unset($_SESSION["evento_cadastrado"]); ?>
					<?php endif; ?>
					
					<?php if(isset($_SESSION["evento_alterado"])): ?>
						<p class="evento-cadastrado"><?=$_SESSION["evento_alterado"]; ?></p>
					<?php unset($_SESSION["evento_alterado"]); ?>
				<?php endif; ?>
