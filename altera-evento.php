	...
	<body>
		...
		<?php endif; ?>
			...
			<div class="container-form-events">
				<div class="container-other-info">
					<div class="container-see-all-events">
						<a href="eventos.php">Ver todos os Artigos cadastrados</a>
					</div>
					<div class="container-see-all-events">
			...
			<div class="container-form-register-event">
				<form action="banco-altera-eventos.php" method="post" enctype="multipart/form-data">
					...
					<textarea class="description-event" name="descricao" required><?=$evento['descricao']; ?></textarea>
